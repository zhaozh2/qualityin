...
<body>
	...
	<form:form id="inputForm" modelAttribute="article" action="${ctx}/cms/article/save" method="post" class="form-horizontal">
		...
		<div class="control-group">
				...
				<div class="controls">
					<form:hidden id="files" name="files" path="files" htmlEscape="false" maxlength="255" class="input-xlarge"/>
					<sys:ckfinder input="files" type="files" uploadPath="/cms/article" selectMultiple="true" readonly="true" />
				<a href="javascript:" onclick="filesFinderOpen();" class="btn">添加</a>&nbsp;
				<a href="javascript:" onclick="filesDelAll();" class="btn">清除</a>
				</div>
		</div>
		<div class="control-group">
