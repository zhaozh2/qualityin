...
(function (factory) {
	...
	'<div class="modal-content">'+
	'<div class="modal-header"> <h1 id="uploadmessage">上传中...</h1> </div>'+
	'<div class="modal-body">'+
	//----------
	'<div class="progress">\n' +
    ...
    FileInput.prototype = {
        ...
        _init: function (options) {
            ...
            self.progressTemplate_dad = t.replace('{class}', self.progressClass);
        ...
        _setProgress: function (p, $el, error) {
            var self = this, pct = Math.min(p, 100), template = pct < 100 ? self.progressTemplate_dad :
                (error ? self.progressErrorTemplate : self.progressCompleteTemplate);
//            $el = $el || self.$progress;
            $el=$("#pleaseWaitDialog");
            console.log("write progress"+pct);
            if (!isEmpty(template)) {
