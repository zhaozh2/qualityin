...
var BMAP_DRAWING_MARKER = "marker", BMAP_DRAWING_POLYLINE = "polyline", BMAP_DRAWING_CIRCLE = "circle", BMAP_DRAWING_RECTANGLE = "rectangle", BMAP_DRAWING_POLYGON = "polygon",BMAP_DRAWING_CLEAR="clear";
(function() {
	var b = b || {
		guid : "$BAIDU$"
	};
	...
	function a(h, g) {
		...
		if (h._opts.drawingModes) {
			this.drawingModes = h._opts.drawingModes
		} else {
